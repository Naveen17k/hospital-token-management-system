...
export default function DoctorPanel() {
  ...
  const [showConfirmation, setShowConfirmation] = useState(false); // State to control showing/hiding confirmation dialog
  ...
  return (
    <div className="bg-white">
      ...
      {showConfirmation && (
        <ConfirmationDialog
          message="Are you sure want to end the token registration ?"
      ...
      <div className="absolute right-0 px-4 w-1/2 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mt-8 flow-root overflow-x-auto">
          <div className="inline-block min-w-full py-2 text-center align-middle sm:px-6 lg:px-8">
            ...
            <div className="max-w-max h-[451px] overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent">
